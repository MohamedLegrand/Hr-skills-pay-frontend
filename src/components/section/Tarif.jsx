// Tarif.jsx - Page des tarifs et abonnements - Version responsive
...
const ContactModal = ({ onClose }) => {
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl max-w-[90vw] sm:max-w-md w-full p-4 sm:p-6 shadow-2xl animate-fadeInUp" 
      ...
      >
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-violet-100 flex items-center justify-center group-hover:bg-violet-200 transition-colors">
        ...
        <button
          onClick={onClose}
          className="w-full mt-4 sm:mt-6 px-4 py-2.5 sm:py-3 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl font-semibold text-sm sm:text-base hover:shadow-lg hover:-translate-y-0.5 transition-all"
        >
          Fermer
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                {plan.badge && (
                  <div className="absolute top-0 left-0 right-0 py-1.5 sm:py-2 text-center text-[10px] sm:text-xs font-bold text-white bg-gradient-to-r from-violet-600 to-indigo-600">
                    {plan.badge}
                  </div>
                )}
