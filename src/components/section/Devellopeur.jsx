...
import { 
  ...
  Users, MessageSquare, Rocket, Layers, Clock
} from 'lucide-react'; 
...
const EndpointCard = ({ endpoint }) => {
  ...
  return (
    <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200 hover:border-violet-300 transition-colors">
      ...
      <div className="text-right flex-shrink-0">
        <div className="flex items-center gap-2">
          {endpoint.auth === 'required' && <Key className="w-3.5 h-3.5 text-amber-500" />}
...
const SDKCard = ({ sdk }) => (
  <div className="p-4 bg-white rounded-xl border border-slate-200 hover:border-violet-300 hover:shadow-lg transition-all group">
    <div className="flex items-start justify-between mb-3">
      <h4 className="font-semibold text-slate-900 group-hover:text-violet-700 transition-colors">{sdk.name}</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-semibold text-amber-200">Clés API</span>
                </div>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <a href="/docs/quickstart" className="inline-flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-violet-500 to-indigo-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all group">
                  <span>Commencer l'intégration</span>
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="/dashboard" className="inline-flex items-center gap-2 px-6 py-3.5 bg-white/10 border border-white/20 text-white rounded-xl font-semibold hover:bg-white/20 transition-all">
  ...
  "method": "orange_money"
        ...
        <div className="mb-16 lg:mb-20">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/docs/api" className="text-sm font-semibold text-violet-400 hover:text-violet-300 flex items-center gap-1">
        ...
        <div className="mb-16 lg:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {apiFeatures.map((feature, index) => {
              ...
              return (
                <div key={index} className="p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-colors">
